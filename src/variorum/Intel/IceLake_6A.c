...
int fm_06_6a_cap_power_limits(int package_power_limit)
{
    unsigned socket;
    unsigned nsockets, ncores, nthreads;
    variorum_get_topology(&nsockets, &ncores, &nthreads);
...
int fm_06_6a_get_thermals(int long_ver)
{
#ifdef VARIORUM_LOG
    printf("Running %s\n", __FUNCTION__);
#endif
...
int fm_06_6a_get_counters(int long_ver)
{
#ifdef VARIORUM_LOG
    printf("Running %s\n", __FUNCTION__);
#endif
...
int fm_06_6a_get_clocks(int long_ver)
{
#ifdef VARIORUM_LOG
    printf("Running %s\n", __FUNCTION__);
#endif
...
int fm_06_6a_poll_power(FILE *output)
{
#ifdef VARIORUM_LOG
    printf("Running %s\n", __FUNCTION__);
#endif
...
int fm_06_6a_monitoring(FILE *output)
{
#ifdef VARIORUM_LOG
    printf("Running %s\n", __FUNCTION__);
#endif
...
int fm_06_6a_get_node_power_json(json_t *get_power_obj)
{
#ifdef VARIORUM_LOG
    printf("Running %s\n", __FUNCTION__);
#endif
...
int fm_06_6a_cap_best_effort_node_power_limit(int node_limit)
{
#ifdef VARIORUM_LOG
    printf("Running %s\n", __FUNCTION__);
#endif
    ...
    fm_06_6a_cap_power_limits(pkg_limit);

    return 0;
}

int fm_06_6a_get_frequencies(void)
{
#ifdef VARIORUM_LOG
    printf("Running %s\n", __FUNCTION__);
#endif
